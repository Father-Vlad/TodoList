...
namespace TodoList.Core.ViewModels
{
    public class CollectionOfDoneTasksViewModel : MvxViewModel<Action>
    {
        ...
        public CollectionOfDoneTasksViewModel(IMvxNavigationService navigationService, ITaskService taskService, ILoginService loginService, ITelegramService shareTextToTelegramService, IWebApiService webApiService)
        {
